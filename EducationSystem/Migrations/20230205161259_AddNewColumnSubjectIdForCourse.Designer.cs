...
namespace EducationSystem.Migrations
{
    ...
    [Migration("20230205161259_AddNewColumnSubjectIdForCourse")]
    partial class AddNewColumnSubjectIdForCourse
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EducationSystem.Entities.DbModels.Education.Course", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<int?>("SubjectId")
                        ...
                        .HasComment("Уникальный идентификатор предмета");
            ...
            modelBuilder.Entity("EducationSystem.Entities.DbModels.Education.Subject", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("EducationSystem.Entities.DbModels.Identity.ApplicationSettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("EducationSystem.Entities.DbModels.Education.Course", b =>
                {
                    b.HasOne("EducationSystem.Entities.DbModels.Education.Subject", "Subject")
                        .WithMany()
            ...
            modelBuilder.Entity("EducationSystem.Entities.DbModels.Material.LaboratoryWork.LaboratoryWork", b =>
                {
                    b.HasOne("EducationSystem.Entities.DbModels.Education.Course", "Course")
                        .WithMany()
